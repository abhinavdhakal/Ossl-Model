...
if __name__ == "__main__":
    ...
    for target_column in config['targets']:
        ...
        output_image_path = f'{folder_path}/evaluation_results/cubist_{spectra_type}_{target_column}_evaluation_{number_of_data}{output_image_suffix}.png'
