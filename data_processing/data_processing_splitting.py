...
def process_data(spectra_path, soillab_path, train_test_dir, dataset_type, target_columns, id_column, no_of_data):
    ...
    json_file_path = f'{train_test_dir}/train_test_splits_{dataset_type}.json'
...
if __name__ == "__main__":
    ...
    id_column = 'id.layer_uuid_txt'  # Column name to use for saving train-test split
    ...
    mir_data_path = folder_path + '/datasets/ossl_mir_L0_v1.2.csv'
    soillab_path = folder_path + '/datasets/ossl_soillab_L0_v1.2.csv'
    ...
    visnir_data_path = folder_path + '/datasets/ossl_visnir_L0_v1.2.csv'
    
    # Process VisNIR data
    process_data(visnir_data_path, soillab_path, train_test_dir, 'visnir', target_columns, id_column, number_of_data)
